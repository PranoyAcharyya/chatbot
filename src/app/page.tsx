...
export default function ChatPage() {
  ...
  return (
    <div className="h-screen flex flex-col container mx-auto relative">
      ...
      {/* Input */}
      <div className=" z-40 p-4 border dark:border-red-500/50 rounded-4xl flex gap-2 fixed bottom-4 left-1/2 -translate-x-1/2 w-[100vw] md:w-[70vw] bg-white-30 backdrop-blur-3xl">
        <Input
          value={input}
